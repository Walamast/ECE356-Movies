...
load data infile '/var/lib/mysql-files/project/AllMovies.csv' into table Movies
...
load data infile '/var/lib/mysql-files/project/mpaaIMDBFixed.csv' into table mpaa
     fields terminated by ','
     enclosed by '"'
     lines terminated by '\r\n'
     ignore 1 lines
...
load data infile '/var/lib/mysql-files/project/MovieProductionCompanyIMDBFixed.csv' into table MovieProductionCompanyIMDB
     fields terminated by ','
     enclosed by '"'
     lines terminated by '\r\n'
     ignore 1 lines
...
load data infile '/var/lib/mysql-files/project/MovieGenreIMDBFixed.csv' into table MovieGenreIMDB
     fields terminated by ','
     enclosed by '"'
     lines terminated by '\r\n'
     ignore 1 lines
...
load data infile '/var/lib/mysql-files/project/MovieLanguageIMDBFixed.csv' into table MovieLanguageIMDB
     fields terminated by ','
     enclosed by '"'
     lines terminated by '\r\n'
     ignore 1 lines
...
load data infile '/var/lib/mysql-files/project/IMDBtitlePrinciplesFixed.csv' into table IMDBtitlePrinciples
     fields terminated by ','
     enclosed by '"'
     lines terminated by '\r\n'
     ignore 1 lines
...
load data infile '/var/lib/mysql-files/project/RatingsIMDBFixed.csv' into table tempRatingsIMDB
     fields terminated by ','
     enclosed by '"'
     lines terminated by '\r\n'
     ignore 1 lines
...
load data infile '/var/lib/mysql-files/project/UserRatingDemographicsFixed.csv' into table UserDemoTemp
     fields terminated by ','
     enclosed by '"'
     lines terminated by '\r\n'
     ignore 1 lines
